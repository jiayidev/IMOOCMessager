...
import net.brian.italker.common.app.ToolbarActivity;
import net.brian.italker.push.R;
import net.brian.italker.push.frags.search.SearchGroupFragment;
import net.brian.italker.push.frags.search.SearchUserFragment;
