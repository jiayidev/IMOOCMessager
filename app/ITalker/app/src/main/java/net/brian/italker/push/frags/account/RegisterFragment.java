package net.brian.italker.push.frags.account;
...
import net.brian.italker.factory.presenter.account.RegisterContract;
import net.brian.italker.factory.presenter.account.RegisterPresenter;
