package net.brian.italker.push.frags.main;
...
import net.brian.italker.factory.presenter.contact.ContactContract;
import net.brian.italker.factory.presenter.contact.ContactPresenter;
import net.brian.italker.push.R;
import net.brian.italker.push.activities.MessageActivity;
...
public class ContactFragment extends PresenterFragment<ContactContract.Presenter>
    ...
    protected void initWidget(View root) {
        ...
        mAdapter.setListener(
                new RecyclerAdapter.AdapterListenerImpl<User>() {
            @Override
