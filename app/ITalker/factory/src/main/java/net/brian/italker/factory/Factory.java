package net.brian.italker.factory;
...
import net.brian.italker.factory.utils.DBFlowExclusionStrategy;

import java.util.concurrent.Executor;
import java.util.concurrent.Executors;

/**
 * Created by with_you on 2017/6/4.
 */
...
public class Factory {
     ...
     * @param runnable
     */
    public static void runObAsync(Runnable runnable) {
        //拿到单例，拿到线程池，然后异步执行
