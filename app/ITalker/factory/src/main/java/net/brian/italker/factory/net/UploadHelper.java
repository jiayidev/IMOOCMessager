...
import net.brian.italker.utils.HashUtil;
...
public class UploadHelper {
    ...
    //上传的仓库名
    private static final String BUCKET_NAME = "italker-brian";

    private static OSS getClient() {
        // 明文设置secret的方式建议只在测试时使用，更多鉴权模式请参考后面的`访问控制`章节
        OSSCredentialProvider credentialProvider = new OSSPlainTextAKSKCredentialProvider(
                "LTAI3UyhdPpqiwkp", "cwHGzJJzluZHniQWFUsRC38Oqq6V3l");
    ...
    //image/201705/dasdawasdfg152.jpg
    ...
    //portrait/201705/dasdawasdfg152.jpg
    ...
    //audio/201705/dasdawasdfg152.jpg
